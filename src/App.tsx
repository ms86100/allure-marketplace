  ...
  return (
    ...
    <Suspense fallback={<PageLoadingFallback />}>
      <Routes>
        ...
        <Route path="/discovery/:type" element={<ProtectedRoute><RouteErrorBoundary sectionName="Discovery"><DiscoveryListingsPage /></RouteErrorBoundary></ProtectedRoute>} />
        ...
        <Route path="/seller/products/new" element={<ProtectedRoute><SellerRoute><RouteErrorBoundary sectionName="Add Product"><SellerProductFormPage /></RouteErrorBoundary></SellerRoute></ProtectedRoute>} />
