...
import { ArrowLeft, Plus, Edit, Trash2, Star, ShieldAlert, Store, Upload, Send, CheckCircle2, Clock, XCircle, Eye } from 'lucide-react';
      ...
      <div className="p-4">
        ...
        {sp.products.length > 0 ? (
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-2 flex-wrap">
                        <Link to={`/seller/products/edit/${product.id}`}>
                          <Button size="sm" variant="outline"><Edit size={14} className="mr-1" />Edit</Button>
                        </Link>
          ...
          <div className="text-center py-12 bg-muted rounded-xl">
            ...
            <Link to="/seller/products/new">
              <Button><Plus size={16} className="mr-1" />Add Your First Product</Button>
            </Link>
          </div>
        )}
      </div>
